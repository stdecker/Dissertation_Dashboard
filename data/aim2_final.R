...
pyruvate_vmax <- ggplot(subset(aim_2_combined_3Param, Substrate %in% "Pyruvate"), aes(x = Tissue, y = Vmax, color = Smoke)) +
  ...
  geom_beeswarm(cex = 3, data = subset(aim_2_combined_3Param, Substrate %in% "Pyruvate"), aes(x = Tissue, y = Vmax, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
...
pyruvatePC_vmax <- ggplot(subset(aim_2_combined_3Param, Substrate %in% "Pyruvate in PC"), aes(x = Tissue, y = Vmax, color = Smoke)) +
  #stat_summary(fun.data = "mean_se", geom = "errorbar", position = position_dodge(width=0.9), width = 0.3, size = 1, na.rm = TRUE) +
  stat_summary(geom = "bar", position = position_dodge(0.95), size = 1, fill = "white") +
  theme_prism() +
  scale_color_manual(values = c("red", "blue")) +
  ...
  geom_beeswarm(cex = 3, data = subset(aim_2_combined_3Param, Substrate %in% "Pyruvate in PC"), aes(x = Tissue, y = Vmax, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
...
palmitate_vmax <- ggplot(subset(aim_2_combined_3Param, Substrate %in% c("PC")), aes(x = Tissue, y = Vmax, color = Smoke)) +
  #stat_summary(fun.data = "mean_se", geom = "errorbar", position = position_dodge(width=0.9), width = 0.3, size = 1, na.rm = TRUE) +
  stat_summary(geom = "bar", position = position_dodge(0.95), size = 1, fill = "white") +
  theme_prism() +
  scale_color_manual(values = c("red", "blue")) +
  ...
  geom_beeswarm(cex = 3, data = subset(aim_2_combined_3Param, Substrate %in% "PC"), aes(x = Tissue, y = Vmax, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
...
pyruvate_km <- ggplot(subset(aim_2_combined_3Param, Substrate %in% "Pyruvate"), aes(x = Tissue, y = Km, color = Smoke)) +
  #stat_summary(fun.data = "mean_se", geom = "errorbar", position = position_dodge(width=0.9), width = 0.3, size = 1, na.rm = TRUE) +
  stat_summary(geom = "bar", position = position_dodge(0.95), size = 1, fill = "white") +
  theme_prism() +
  scale_color_manual(values = c("red", "blue")) +
  ...
  geom_beeswarm(cex = 3, data = subset(aim_2_combined_3Param, Substrate %in% "Pyruvate"), aes(x = Tissue, y = Km, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
...
pyruvatePC_km <- ggplot(subset(aim_2_combined_3Param, Substrate %in% "Pyruvate in PC"), aes(x = Tissue, y = Km, color = Smoke)) +
  #stat_summary(fun.data = "mean_se", geom = "errorbar", position = position_dodge(width=0.9), width = 0.3, size = 1, na.rm = TRUE) +
  stat_summary(geom = "bar", position = position_dodge(0.95), size = 1, fill = "white") +
  theme_prism() +
  scale_color_manual(values = c("red", "blue")) +
  ...
  geom_beeswarm(cex = 3, data = subset(aim_2_combined_3Param, Substrate %in% "Pyruvate in PC"), aes(x = Tissue, y = Km, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
...
palmitate_km <- ggplot(subset(aim_2_combined_3Param, Substrate %in% c("PC")), aes(x = Tissue, y = Km, color = Smoke)) +
  #stat_summary(fun.data = "mean_se", geom = "errorbar", position = position_dodge(width=0.9), width = 0.3, size = 1, na.rm = TRUE) +
  stat_summary(geom = "bar", position = position_dodge(0.95), size = 1, fill = "white") +
  theme_prism() +
  scale_color_manual(values = c("red", "blue")) +
  ...
  geom_beeswarm(cex = 3, data = subset(aim_2_combined_3Param, Substrate %in% "PC"), aes(x = Tissue, y = Km, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
...
pyr_percent_km <- ggplot(percent_combined[-c(18,34),], aes(x = Tissue, y = Km, color = Smoke)) +
  #stat_summary(fun.data = "mean_se", geom = "errorbar", position = position_dodge(width=0.9), width = 0.3, size = 1, na.rm = TRUE) +
  stat_summary(geom = "bar", position = position_dodge(0.95), size = 1, fill = "white") +
  theme_prism() +
  scale_color_manual(values = c("red", "blue")) +
  ...
  geom_beeswarm(cex = 3, data = percent_combined[-c(34),], aes(x = Tissue, y = Km, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
...
pyr_percent_km2 <- ggplot(percent_combined[-c(18,34),], aes(x = Tissue, y = Km2, color = Smoke)) +
  #stat_summary(fun.data = "mean_se", geom = "errorbar", position = position_dodge(width=0.9), width = 0.3, size = 1, na.rm = TRUE) +
  stat_summary(geom = "bar", position = position_dodge(0.95), size = 1, fill = "white") +
  theme_prism() +
  scale_color_manual(values = c("red", "blue")) +
  ...
  # geom_point(data = percent_combined[-c(34),], aes(x = Tissue, y = Km, fill = Smoke), position = position_dodge(0.99), size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
  geom_beeswarm(cex = 3, data = percent_combined[-c(34),], aes(x = Tissue, y = Km2, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
...
pyr_percent_vmax2 <- ggplot(percent_combined, aes(x = Tissue, y = Vmax2, color = Smoke)) +
  #stat_summary(fun.data = "mean_se", geom = "errorbar", position = position_dodge(width=0.9), width = 0.3, size = 1, na.rm = TRUE) +
  stat_summary(geom = "bar", position = position_dodge(0.95), size = 1, fill = "white") +
  theme_prism() +
  scale_color_manual(values = c("red", "blue")) +
  ...
  # geom_point(data = percent_combined, aes(x = Tissue, y = Vmax, fill = Smoke), position = position_dodge(0.99), size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
  geom_beeswarm(cex = 3, data = percent_combined, aes(x = Tissue, y = Vmax2, color = Smoke), dodge.width = 0.99, size = 2, pch = 21, stroke = 1.5, show.legend = FALSE) +
