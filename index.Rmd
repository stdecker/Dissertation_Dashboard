...
aim2_outline <- image_read("data/Images/CAT Mechanisms.png")
...
```{r}
ggplotly(abs_line)%>%
   layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
`Gastrocnemius` <- #Gastrocnemius_line
ggplotly(Gastrocnemius_line) %>%
   layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
  add_lines(x = c(7.2, 7.2, 7.5, 7.5), y = c(55,55,55,55), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none')%>%
  add_text(x = 7.35, y = 55.5, text = "<b>*</b>", textfont = list(size = 20), hoverinfo = 'none')
...
ggplotly(Soleus_line) %>%
  ...
  add_text(x = 7.125, y = 111, text = "<b>*</b>", textfont = list(size = 20), hoverinfo = 'none')

`Heart` <- #Heart_line
ggplotly(Heart_line) %>%
   layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
  add_lines(x = c(7.25, 7.25, 7.5, 7.5), y = c(325,325,325,325), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none')%>%
  add_text(x = 7.375, y = 327, text = "<b>*</b>", textfont = list(size = 20), hoverinfo = 'none')

`Aorta` <- #Aorta_line
ggplotly(Aorta_line) %>%
   layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
  add_lines(x = c(7.35, 7.35, 7.5, 7.5), y = c(27.5,27.5,27.5,27.5), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none')%>%
  add_text(x = 7.425, y = 28, text = "<b>*</b>", textfont = list(size = 20), hoverinfo = 'none')

ui3 <-shinyUI(fixedPage(
  selectInput("selectPlot", "Tissue", choices=c("Gastrocnemius", "Soleus", "Heart", "Aorta")),
                      plotlyOutput("plot")))
...
server3 <- shinyServer(function(input,output){
 ...
 shinyApp(ui3,server3, options = list(height = 625))
...
abs_break <- ggplotly(individual_inflection) %>%
  layout(yaxis = list(title = "<b>[CSC] at Break (μg/mL)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14))) %>%
  add_lines(x = c(1, 4, 4, 1), y = c(900,900,900,900), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 2.5, y = 925, text = "<b>p = 0.001</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(3, 4, 4, 3), y = c(950,950,950,950), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 3.5, y = 975, text = "<b>p = 0.005</b>", textfont = list(size = 20), hoverinfo = 'none')


abs_slope <- ggplotly(individual_slope2) %>%
  layout(yaxis = list(title = "<b>Slope After Break (<i>J</i>O<sub>2</sub>/[CSC])</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14), side = "top")) %>%
  add_lines(x = c(1, 2, 2, 1), y = c(-235,-235,-235,-235), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 1.5, y = -242, text = "<b>p < 0.047</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(1, 3, 3, 1), y = c(-260,-260,-260,-260), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 2, y = -267, text = "<b>p < 0.001</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(1, 4, 4, 1), y = c(-280,-280,-280,-280), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 2.5, y = -287, text = "<b>p < 0.001</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(2, 3, 3, 2), y = c(-120,-120,-120,-120), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 2.5, y = -127, text = "<b>p = 0.018</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(2, 4, 4, 2), y = c(-165,-165,-165,-165), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 3, y = -172, text = "<b>p = 0.002</b>", textfont = list(size = 20), hoverinfo = 'none')

subplot(abs_break, abs_slope, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(list(text = "<b>[CSC] at Break </b>", x = 0.2,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
ggplotly(con_CS_activity)%>%
   layout(yaxis = list(title = "<b>CS Activity (AU)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
```{r}
ggplotly(CS_line) %>%
   layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/CS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
`Gastrocnemius per Citrate Synthase Activity` <- ggplotly(Gastrocnemius_CSline) %>%
   layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/CS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
  add_lines(x = c(7.2, 7.2, 7.5, 7.5), y = c(10,10,10,10), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 7.35, y = 10.05, text = "<b>*</b>", textfont = list(size = 20), hoverinfo = 'none')


`Soleus per Citrate Synthase Activity` <- ggplotly(Soleus_CSline) %>%
layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/CS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
  add_lines(x = c(6.75, 6.75, 7.5, 7.5), y = c(7.5,7.5,7.5,7.5), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 7.125, y = 7.55, text = "<b>*</b>", textfont = list(size = 20), hoverinfo = 'none')

`Heart per Citrate Synthase Activity` <- ggplotly(Heart_CSline) %>%
layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/CS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
  add_lines(x = c(7.25, 7.25, 7.5, 7.5), y = c(6.25,6.25,6.25,6.25), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none')%>%
  add_text(x = 7.375, y = 6.3, text = "<b>*</b>", textfont = list(size = 20), hoverinfo = 'none')

`Aorta per Citrate Synthase Activity` <- ggplotly(Aorta_CSline) %>%
layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/CS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
  add_lines(x = c(7.35, 7.35, 7.5, 7.5), y = c(1.6,1.6,1.6,1.6), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none')%>%
  add_text(x = 7.425, y = 1.61, text = "<b>*</b>", textfont = list(size = 20), hoverinfo = 'none')

ui4 <-shinyUI(fixedPage(
  selectInput("selectPlot", "Tissue", choices=c("Gastrocnemius per Citrate Synthase Activity", "Soleus per Citrate Synthase Activity", "Heart per Citrate Synthase Activity", "Aorta per Citrate Synthase Activity")),
                      plotlyOutput("plot2")))

server4 <- shinyServer(function(input, output){
  output$plot2 <- renderPlotly({
    return(get(input$selectPlot)) # get("p1") from the workspace returns the object p1, which is a plotly object
  })
})

shinyApp(ui4,server4, options = list(height = 625))
```
...
```{r}
abs_break <- ggplotly(CS_individual_inflection) %>%
  layout(yaxis = list(title = "<b>[CSC] at Break (μg/mL)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14))) %>%
  add_lines(x = c(1, 4, 4, 1), y = c(1050,1050,1050,1050), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 2.5, y = 1075, text = "<b>p = 0.001</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(2, 4, 4, 2), y = c(975,975,975,975), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 3, y = 1000, text = "<b>p = 0.026</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(3, 4, 4, 3), y = c(900,900,900,900), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 3.5, y = 925, text = "<b>p = 0.002</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(1, 2, 2, 1), y = c(450,450,450,450), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 1.5, y = 475, text = "<b>p = 0.025</b>", textfont = list(size = 20), hoverinfo = 'none')


abs_slope <- ggplotly(CS_individual_slope) %>%
  layout(yaxis = list(title = "<b>Slope After Break (<i>J</i>O<sub>2</sub>/[CSC])</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14), side = "top")) %>%
  add_lines(x = c(1, 4, 4, 1), y = c(-7.5,-7.5,-7.5,-7.5), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 2.5, y = -7.75, text = "<b>p < 0.001</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(2, 4, 4, 2), y = c(-7,-7,-7,-7), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 3, y = -7.25, text = "<b>p < 0.001</b>", textfont = list(size = 20), hoverinfo = 'none') %>%
  add_lines(x = c(3, 4, 4, 3), y = c(-6.5,-6.5,-6.5,-6.5), showlegend = F, line = list(color = 'black'), legendgroup = 1, hoverinfo = 'none') %>%
  add_text(x = 3.5, y = -6.75, text = "<b>p = 0.021</b>", textfont = list(size = 20), hoverinfo = 'none') 
...
ggplotly(CS_activity) %>%
  layout(yaxis = list(title = "<b>Citrate Synthase Activity (AU)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
```{r}
aim2_methods <- image_read("data/Images/6 - copy of Aim 3.png")
...
ggplotly(cat_RotFCCP) %>%
   layout(yaxis = list(title = "<b>Contribution of Complex II (Rot/FCCP)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
ggplotly(cat_GMDSFCCP) %>%
   layout(yaxis = list(title = "<b>Phosphorylation Ratio (GMDS/FCCP)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(ticktext = list("GM", "GMD<sub>5000</sub>", "GMDS", 'CAT<sub>5.0</sub>', "FCCP", "Rot"), linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
...
TC <- ggplotly(cat_Thermodynamic_Coupling) %>%
   layout(yaxis = list(title = "<b>q-value</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

RCR <- ggplotly(cat_RCR) %>%
   layout(yaxis = list(title = "<b>Respiratory Control Ratio (GMDS/GM)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

subplot(RCR, TC, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(list(text = "<b>RCR</b>", x = 0.2,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
fccpdiffs <- ggplotly(FCCP_diff) %>% 
  layout(yaxis = list(title = "<b>&#x394; FCCP<sub>Peak</sub></b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

catdiffs <- ggplotly(CAT_diff) %>% 
  layout(yaxis = list(title = "<b>CSC-Induced ANT Inhibition</sub></b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

subplot(fccpdiffs, catdiffs, shareY = FALSE, titleY = TRUE)
...
ggplotly(adp_kinetics)%>% 
  layout(yaxis = list(title = "<b><i>J</i>O<sub>2</sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(title = '<b>[ADP] (&#x3BC;M)</b>',linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
ADP_km <- ggplotly(adp_km) %>% 
  layout(yaxis = list(title = "<b>[ADP] (&#x3BC;M)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

ADP_vmax <- ggplotly(adp_vmax) %>% 
  layout(yaxis = list(title = "<b><i>J</i>O<sub>2</sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

subplot(ADP_km, ADP_vmax, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(list(text = "<b>ADP K<sub>m</sub></b>", x = 0.2,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
ggplotly(cat_kinetics) %>% 
  layout(yaxis = list(title = "<b><i>J</i>O<sub>2</sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub></b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(title = '<b>[CAT] &#x3BC;M</b>',linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
CAT_km <- ggplotly(cat_km) %>% 
  layout(yaxis = list(title = "<b>[CAT] (&#x3BC;M)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

CAT_percent <- ggplotly(cat_percent) %>% 
  layout(yaxis = list(title = "<b>Inhibition (% V<sub>max</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(side = "top", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

subplot(CAT_vmax, CAT_km, CAT_imax, CAT_percent, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(
...
ggplotly(h2o2_kinetics) %>%
   layout(yaxis = list(title = "<b><i>J</i>H<sub>2</sub>O<sub>2</sub> (pmol<sub>H<sub>2</sub>O<sub>2</sub></sub>/mg<sub>wt</sub>/sec)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
subplot(h2o2_VMAX, h2o2_KM, H2o2_IMAX, h2o2_PERCENT, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(
  list(text = "<b>H<sub>2</sub>O<sub>2</sub> Initial Rate (C)</b>", x = 0.13,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
    yanchor = "bottom",  
    showarrow = FALSE 
  ), list(text = "<b>H<sub>2</sub>O<sub>2</sub> IC<sub>50</sub></b>", x = 0.4,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
    yanchor = "bottom",  
    showarrow = FALSE 
  ), list(text = "<b>H<sub>2</sub>O<sub>2</sub> I<sub>max</sub></b>", x = 0.65,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
ggplotly(percent_kinetics) %>%
   layout(yaxis = list(title = "<b><i>J</i>H<sub>2</sub>O<sub>2</sub> (% of GMS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
h2o2_PERCENT <- ggplotly(h2o2_percent) %>% 
  layout(yaxis = list(title = "<b>Inhibition (% Initial)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(side = "top", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

subplot(h2o2_KM, h2o2_PERCENT, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(
  list(text = "<b>K<sub>m</sub></b>", x = 0.13,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
ggplotly(plot_h2o2_per_kinetics) %>%
   layout(yaxis = list(title = "<b>Mitochondrial Efficiency (pmol<sub>H<sub>2</sub>O<sub>2</sub></sub>/pmol<sub>O<sub>2</sub></sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
subplot(h2o2_per_VMAX, h2o2_per_KM, H2o2_per_IMAX, h2o2_per_PERCENT, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(
  list(text = "<b>Initial Rate (C)</b>", x = 0.13,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
    yanchor = "bottom",  
    showarrow = FALSE 
  ), list(text = "<b>IC<sub>50</sub></b>", x = 0.4,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
    yanchor = "bottom",  
    showarrow = FALSE 
  ), list(text = "<b>I<sub>max</sub></b>", x = 0.65,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
ggplotly(pyruvate_kinetics) %>% 
  layout(yaxis = list(title = "<b><i>J</i>O<sub>2</sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(title = '<b>[Pyruvate] (&#x3BC;M)</b>',linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
PYRUVATE_km <- ggplotly(pyruvate_km) %>%
   layout(yaxis = list(title = "<b>[Puruvate] (mM)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

PYRUVATE_vmax <- ggplotly(pyruvate_vmax) %>%
   layout(yaxis = list(title = "<b><i>J</i>O<sub>2</sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

subplot(PYRUVATE_km, PYRUVATE_vmax, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(list(text = "<b>K<sub>m</sub></b>", x = 0.2,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
    yanchor = "bottom",  
    showarrow = FALSE 
  ), list(text = "<b>V<sub>max</sub></b>", x = 0.8,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
ggplotly(palm_kinetics) %>% 
  layout(yaxis = list(title = "<b><i>J</i>O<sub>2</sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(title = '<b>[Palmitoylcarnitine] (&#x3BC;M)</b>',linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
```
...
PC_km <- ggplotly(palmitate_km) %>%
   layout(yaxis = list(title = "<b>[Palmitoylcarnitine] (mM)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

PC_vmax <- ggplotly(palmitate_vmax) %>%
   layout(yaxis = list(title = "<b><i>J</i>O<sub>2</sub> (pmol<sub>O<sub>2</sub></sub>/sec/mg<sub>wt</sub>)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

subplot(PC_km, PC_vmax, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(list(text = "<b>K<sub>m</sub></b>", x = 0.2,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
subplot(pyr_PC_km, pyr_PC_vmax, shareY = FALSE, titleY = TRUE) %>% layout(annotations = list(list(text = "<b>K<sub>m</sub></b>", x = 0.2,  
    y = 1.075,  
    xref = "paper",  
    yref = "paper",  
    xanchor = "center",  
...
pyruvate_percent_km <- ggplotly(pyr_percent_km2) %>% 
  layout(yaxis = list(title = "<b>Pyruvate + PC K<sub>m</sub>/Pyruvate K<sub>m</sub> (Percent Change)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))

pyruvate_percent_vmax <- ggplotly(pyr_percent_vmax2) %>% 
  layout(yaxis = list(title = "<b>Pyruvate + PC K<sub>m</sub>/Pyruvate V<sub>max</sub> (Percent Change)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)))
...
shinyUI(
      tabsetPanel(
        ...
        tabPanel("Acute CSC Titrations", value = "Coming Soon"#,
                 # tags$iframe(style="height:700px; width:100%; scrolling=yes",
                 #  src="https://cran.r-project.org/doc/manuals/r-release/R-intro.pdf"
                 #)
        ),
        tabPanel("Mechanisms", value = "Coming Soon"#,
                 # tags$iframe(style="height:700px; width:100%; scrolling=yes",
                 #  src="https://cran.r-project.org/doc/manuals/r-release/R-intro.pdf"
                 #)
        ),
...
#### Substrate Utilixation Manuscript (Jan 2023 in *Life Sciences*): 

**Decker ST**, Matias AA, Bannon ST, Madden JP, Alexandrou-Majaj N, Layec G. Effects of cigarette smoke on in situ mitochondrial substrate oxidation of slow- and fast-twitch skeletal muscles. *Life Sci.* 2023 Jan 13;315:121376. doi: 10.1016/j.lfs.2023.121376. PMID: 36646379.
<br>
