...
`Absolute Gastrocnemius` <- #Gastrocnemius_line
...
ui3 <-shinyUI(fixedPage(
  selectInput("selectPlot", "Tissue", choices=c("Absolute Gastrocnemius", "Absolute Soleus", "Absolute Heart", "Absolute Aorta")),
                      plotlyOutput("plot")))
...
### CS Activitiy is Different Between Tissues
...
### Respiration Normalized to CS Activities
...
### CSC Impairs Respiration Normalized to CS Activity

```{r}

`Gastrocnemius per CS` <- ggplotly(Gastrocnemius_CSline) %>%
...
`Soleus per CS` <- ggplotly(Soleus_CSline) %>%
layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/CS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
...
`Heart per CS` <- ggplotly(Heart_CSline) %>%
layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/CS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
...
`Aorta per CS` <- ggplotly(Aorta_CSline) %>%
layout(yaxis = list(title = "<b><i>J</i><sub>O<sub>2</sub></sub> (pmol<sub>O<sub>2</sub></sub>/sec/CS)</b>", linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black")), xaxis = list(linewidth = 2, tickwidth = 2, tickfont = list(family = "Times New Roman Black", size = 14)), margin = 0) %>%
...
ui4 <-shinyUI(fixedPage(
  selectInput("selectPlot", "Tissue", choices=c("Gastrocnemius per CS", "Soleus per CS", "Heart per CS", "Aorta per CS")),
                      plotlyOutput("plot2")))
